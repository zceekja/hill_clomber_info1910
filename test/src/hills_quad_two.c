 ...
 */
int hills_quad_two(const void* location)
{
    ...
    if (NUM_ATTEMPTS_HILLS_QUAD_TWO < attempts)
    {
        best = 0;
    ...
    int current = hills_quad_two_function(location);
    attempts++;
 ...
 */
int hills_quad_two_function(const void* location)
{
